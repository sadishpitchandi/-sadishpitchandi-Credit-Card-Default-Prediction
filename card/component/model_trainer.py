...
from card.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact
from card.entity.config_entity import ModelTrainerConfig
from card.util.util import load_numpy_array_data,save_object,load_object
from card.entity.model_factory import MetricInfoArtifact, ModelFactory,GridSearchedBestModel
from card.entity.model_factory import evaluate_regression_model



class CardEstimatorModel:
...
-           test_array = load_numpy_array_data(file_path=transformed_test_file_path)
            ...
            housing_model = CardEstimatorModel(preprocessing_object=preprocessing_obj,trained_model_object=model_object)
