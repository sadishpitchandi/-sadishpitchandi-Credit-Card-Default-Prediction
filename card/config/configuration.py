...
from card.entity.config_entity import DataIngestionConfig, DataTransformationConfig,DataValidationConfig,   \
ModelTrainerConfig,ModelEvaluationConfig,ModelPusherConfig,TrainingPipelineConfig
from card.util.util import read_yaml_file
...
class Configuartion:
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        try:
            ...
            add_new_col=data_transformation_config_info[DATA_TRANSFORMATION_ADD_NEW_COL]
